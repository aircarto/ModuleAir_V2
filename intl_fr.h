...
const char INTL_SERVER2[] PROGMEM = "Serveur";
const char INTL_PATH2[] PROGMEM = "Chemin";
const char INTL_PORT2[] PROGMEM = "Port";
const char INTL_USER2[] PROGMEM = "Utilisateur";
const char INTL_PASSWORD2[] PROGMEM = "Mot de passe";
