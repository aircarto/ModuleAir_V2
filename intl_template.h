...
const char INTL_PM_SENSORS[] PROGMEM = "";
const char INTL_THP_SENSORS[] PROGMEM = "";
...
const char INTL_MHZ16[] PROGMEM = "";
const char INTL_MHZ19[] PROGMEM = "";
const char INTL_SGP40[] PROGMEM = "";
...
const char INTL_DISPLAY_FORECAST[] PROGMEM = "";
